...
export function Desktop() {
  ...
  return (
    <div className="w-screen h-screen text-white p-4 bg-[url(https://wallpaperwaifu.com/wp-content/uploads/2021/02/tanjiro-kamado-in-forest-kimetsu-no-yaiba-thumb.jpg)] bg-cover bg-center">
      {/* Desktop Icons Grid */}
